...
class ConvidadosPresentesFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val root = inflater.inflate(R.layout.fragment_presentes, container, false)

        val recycler = root.findViewById<RecyclerView>(R.id.recycler_presentes)
        ...
        mListener = object : ConvidadoListener {
            ...
            override fun onDelete(id: Int) {
                ...
                mViewModel.carregarListaConvidados(ConvidadosConstantes.FILTROS.PRESENTES)
            }
        }
